      ...
      <TableHead>
        ...
        <TableBody>
          {(rowsPerPage > 0
           ...
           <AddCircleIcon color="primary" style={{ fontSize: 40 }} onClick={(e) => removeFromList1(e,row.email)}/>  
              </TableCell>
              <TableCell>
               
           <IndeterminateCheckBoxIcon color="secondary" style={{ fontSize: 40 }} onClick={(e) => removeFromList(e,row.email, row.account)}/>   
            </TableCell>
            </StyledTableRow>
          ))}
